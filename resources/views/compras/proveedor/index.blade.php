		...
		<div class="table-responsive">
			<table class="table table-striped table-bordered table-condensed table-hover">
               ...
               @foreach ($personas as $per)
				<tr>
					<td align="left">{{ $per->nombre}}</td>
					<td align="left">{{ $per->tipo_documento}}</td>
					<td align="left">{{ $per->num_documento}}</td>
					<td align="left">{{ $per->telefono}}</td>
					<td align="left">{{ $per->email}}</td>
					<td align="left">
