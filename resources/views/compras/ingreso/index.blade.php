		...
		<div class="table-responsive">
			<table class="table table-striped table-bordered table-condensed table-hover">
               ...
               @foreach ($ingresos as $ing)
				<tr>
					<td align="left">{{ $ing->fecha_hora}}</td>
					<td align="left">{{ $ing->nombre}}</td>
					<td align="left">{{ $ing->tipo_comprobante.': '.$ing->serie_comprobante.'-'.$ing->num_comprobante}}</td>
					<td align="right">{{ number_format($ing->impuesto,2, '.', ',')}}</td>
