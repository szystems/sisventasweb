            ...
            <div class="panel-body">
                ...
                <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
                    <div class="form-group">
                        ...
                        <input type="number" readonly name="pstock" class="form-control" id="pstock" placeholder="Stock">
                    </div>
                </div>
                <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
                    <div class="form-group">
        ...
        function agregar()
        {
            ...
            if (idarticulo!="" && cantidad!="" && cantidad>0 && descuento!="" && precio_venta!="")
            {
                if (stock-cantidad >= 0)
                {
                    ...
                    subtotal[cont]=(cantidad*precio_venta-(descuento*cantidad));
                    total=total+subtotal[cont];

                    var fila='<tr class="selected" id="fila'+cont+'"><td align="center"><button type="button" class="btn btn-warning" onclick="eliminar('+cont+');">X</button></td><td align="center"><input type="hidden" name="idarticulo[]" value="'+idarticulo+'">'+articulo+'</td><td align="center"><input type="number" readonly name="cantidad[]" value="'+cantidad+'"></td><td align="right"><input type="number" readonly name="precio_venta[]" value="'+precio_venta+'"></td><td align="right"><input type="number" readonly name="descuento[]" value="'+descuento*cantidad+'"></td><td align="right">'+subtotal[cont].toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,')+'</td></tr>'; 
                    cont++;
                    limpiar();
