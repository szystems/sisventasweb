 <?php 
    ...
    {
      DB::update('update users set id_empresa = '.$user->id.' where email = ?', [$user->email]);
    }
  ?>
<!DOCTYPE html>
<html>
  <head>
    ...
    <title>SZ-@Ventas | www.szystems.com</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-mini"><b>SZ-@Ventas</b>V</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>SZ-@Ventas</b></span>
        </a>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      ...
                      <small>www.facebook.com/szystems/</small>
                    </p>
                  </li>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="{{url('ventas\cotizacion')}}"><i class="fa fa-circle-o"></i> Cotizaciones</a></li>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2017 <a href="www.szystems.com">Szystems</a>.</strong> All rights reserved.
      </footer>
